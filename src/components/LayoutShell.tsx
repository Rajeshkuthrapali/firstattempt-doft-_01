...
export default function LayoutShell() {
  return (
    <div className="min-h-screen bg-[#faf7f4] text-[#2d2926] font-['Inter',sans-serif]">
      ...
      {/* ── Footer ───────────────────────────── */}
      <footer
        className="bg-[#f3ece4] border-t border-[#e8e0d8]"
        role="contentinfo"
      >
          ...
          <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
            ...
            <div className="md:col-span-1">
              ...
              <p className="mt-3 text-[13px] leading-relaxed text-[#6b5e54]">
                Handcrafted luxury scented candles. 100% natural soy wax, clean
                burning so you can light your candle responsibly.
              </p>
            </div>
