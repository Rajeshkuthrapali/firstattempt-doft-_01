...
export const metadata: Metadata = {
  title: "Contact Us",
  description: "Get in touch with the DOFT Candles team.",
};
        ...
        <form className="space-y-5">
          ...
          <div>
            ...
            <textarea
              rows={5}
              required
              className="w-full resize-none border border-border px-4 py-3 text-sm outline-none focus:border-primary"
              placeholder="Your message…"
            />
          </div>
          <button
            type="submit"
            className="w-full bg-primary py-3.5 text-sm font-bold uppercase tracking-widest text-white transition-all hover:bg-accent"
          >
            Send Message
          </button>
        </form>
