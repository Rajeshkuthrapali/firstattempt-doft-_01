    ...
    <div className="min-h-[70vh] flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4" noValidate>
          {mode === "register" && (
            <div>
              <label htmlFor="auth-name" className="block text-xs font-medium uppercase tracking-widest text-[#9a8d82] mb-1">
                Full Name
              </label>
              <input
                id="auth-name"
          ...
          <div>
            <label htmlFor="auth-email" className="block text-xs font-medium uppercase tracking-widest text-[#9a8d82] mb-1">
              Email Address
            </label>
            <input
              id="auth-email"
          ...
          <div>
            <label htmlFor="auth-password" className="block text-xs font-medium uppercase tracking-widest text-[#9a8d82] mb-1">
              Password
            </label>
            <input
              id="auth-password"
        ...
        <div className="my-6 flex items-center gap-3">
          ...
          <span className="text-xs text-[#9a8d82] uppercase tracking-widest">or</span>
          <div className="flex-1 border-t border-[#e8e0d8]" />
        </div>
        ...
        {mode === "login" && (
          <p className="mt-2 text-center text-xs text-[#9a8d82]">
            <Link to="/forgot-password" className="text-[#c4a093] hover:underline">
